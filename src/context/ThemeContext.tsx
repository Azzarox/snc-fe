...
export function ThemeProvider({ children, defaultTheme = Theme.SYSTEM, ...props }: ThemeProviderProps) {
	const [theme, setTheme] = useState<Theme>(() => localStorageService.getTheme() || defaultTheme);
