  ...
  return (
    <div className="bg-card rounded-lg border border-border p-4">
      <div className="flex items-center gap-2 mb-4">
        ...
        <h2 className="font-semibold text-card-foreground">Trending Topics</h2>
      </div>
      <div className="space-y-3">
        {topics.map((topic) => (
          <button key={topic.tag} className="w-full text-left p-3 rounded-lg hover:bg-muted transition-colors group">
