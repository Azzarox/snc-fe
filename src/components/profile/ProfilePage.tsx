    ...
    return (
        <div className="min-h-screen bg-background">
            ...
            <div className="relative w-full h-64 bg-gradient-to-br from-primary/20 to-accent/20">
                <img src="/guitar-music-stage-concert.jpg" alt="Cover" className="w-full h-full object-cover" />
            ...
            <div className="container mx-auto px-4 max-w-5xl">
                ...
                <div className="mt-4 pb-6 border-b border-border">
                    <h1 className="text-3xl font-bold text-foreground">Sarah Mitchell</h1>
                    <p className="text-muted-foreground mt-1">@sarahmitchell</p>

                    <p className="mt-4 text-foreground leading-relaxed max-w-2xl">
                        Acoustic guitarist & songwriter 🎸 | Recording artist | Sharing my musical journey and gear reviews | Martin
                ...
                <div className="mt-6 flex gap-8 border-b border-border">
                    <button
                        ...
                        className={`pb-4 px-2 font-medium transition-colors relative ${activeTab === "posts" ? "text-primary" : "text-muted-foreground hover:text-foreground"
                            }`}
                    >
                        Posts
                    ...
                    <button
                        ...
                        className={`pb-4 px-2 font-medium transition-colors relative ${activeTab === "media" ? "text-primary" : "text-muted-foreground hover:text-foreground"
                            }`}
                    >
                        Media
                    ...
                    <button
                        ...
                        className={`pb-4 px-2 font-medium transition-colors relative ${activeTab === "about" ? "text-primary" : "text-muted-foreground hover:text-foreground"
                            }`}
                    >
                        About
                ...
                <div className="mt-6 pb-12">
                    {activeTab === "posts" && (
                        <div className="space-y-6">
                            {userPosts.map((post) => (
                                <article key={post.id} className="bg-card rounded-lg border border-border overflow-hidden">
                                    {/* Post Header */}
                                    <div className="p-4 flex items-start justify-between">
                                        <div className="flex items-start gap-3">
                                            ...
                                            />
                                            <div>
                                                <h3 className="font-semibold text-card-foreground">Sarah Mitchell</h3>
                                                <p className="text-sm text-muted-foreground">@sarahmitchell · {post.timestamp}</p>
                                            </div>
                                        </div>
                        ...
                        <div className="space-y-6">
                            <div className="bg-card rounded-lg border border-border p-6">
                                ...
                                <p className="text-muted-foreground leading-relaxed">
                                    Professional guitarist and music educator with over 10 years of experience. Specializing in acoustic
                                    fingerstyle and contemporary songwriting. I love sharing my passion for music and helping others on
                            ...
                            <div className="bg-card rounded-lg border border-border p-6">
                                ...
                                <ul className="space-y-2 text-muted-foreground">
                                    ...
                                    <li>• Taylor 814ce</li>
                                    <li>• Fender American Professional Stratocaster</li>
                            ...
                            <div className="bg-card rounded-lg border border-border p-6">
                                ...
                                <ul className="space-y-2 text-muted-foreground">
                                    ...
                                    <li>• Endorsed artist for Martin Guitars</li>
                                </ul>
                            </div>
                        </div>
                    )}
